...
public class Chapter4Fig1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        maxParticles = 1;
        psf1 = new particleSystemFigure1(particleSystemLocation, startSpeed, velocity, lifeTime, maxParticles, material, emissionRate);
    }
}
...
public class particleSystemFigure1
{
    ...
    public particleSystemFigure1(Vector3 particleSystemLocation, float startSpeed, Vector3 velocity, float lifeTime, int maxParticles, Material material, float emissionRate)
    {
