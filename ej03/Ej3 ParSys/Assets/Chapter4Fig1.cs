...
public class Chapter4Fig1 : MonoBehaviour
{
    ...
    public Vector3 particleSystemLocationFig1;
    public Vector3 particleSystemLocationFig2;
    ...
    void Start()
    {
        ...
        maxParticles = 200;
        psf1 = new particleSystemFigure1(particleSystemLocationFig1, startSpeed, velocity, lifeTime, maxParticles, material, emissionRate);
        psf2 = new particleSystemFigure2(particleSystemLocationFig2, startSpeed, velocity, lifeTime, maxParticles, material, emissionRate);
    }
}
...
public class particleSystemFigure1
{
    ...
    public particleSystemFigure1(Vector3 particleSystemLocationFig1, float startSpeed, Vector3 velocity, float lifeTime, int maxParticles, Material material, float emissionRate)
    {
        //Create the GameObject in the constructor
        particleSystemGameObject = new GameObject();
        //Move the GameObject to the right position
        particleSystemGameObject.transform.position = particleSystemLocationFig1;
    ...
    public void colorModule(Material material)
    {
        ...
        grad.SetKeys(new GradientColorKey[] { new GradientColorKey(Color.green, 0.0f),new GradientColorKey(Color.blue, 0.5f) , new GradientColorKey(Color.cyan, 1.0f) }, new GradientAlphaKey[] { new GradientAlphaKey(1.0f, 0.0f), new GradientAlphaKey(0f, 2.0f) });
        //Set the color to the gradient we created above
        colorOverLifetime.color = grad;
    }

    public void emissionModule(float emissionRate)
    {
...
public class particleSystemFigure2
{
    ...
    public particleSystemFigure2(Vector3 particleSystemLocationFig2, float startSpeed, Vector3 velocity, float lifeTime, int maxParticles, Material material, float emissionRate)
    {
        //Create the GameObject in the constructor
        particleSystemGameObject = new GameObject();
        //Move the GameObject to the right position
        particleSystemGameObject.transform.position = particleSystemLocationFig2;
        //Add the particle system
        particleSystemComponent = particleSystemGameObject.AddComponent<ParticleSystem>();
    ...
    public void colorModule(Material material)
    {
        ...
        //This gradient key lets us choose points on a gradient that represent different RGBA or Unity.Color values.
        //These gradient values exist in an array
        grad.SetKeys(new GradientColorKey[] { new GradientColorKey(Color.green, 0.0f), new GradientColorKey(Color.blue, 0.5f), new GradientColorKey(Color.red, 1.0f) }, new GradientAlphaKey[] { new GradientAlphaKey(1.0f, 0.0f), new GradientAlphaKey(0f, 2.0f) });
        //Set the color to the gradient we created above
        colorOverLifetime.color = grad;
    }
