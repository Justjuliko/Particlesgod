...
public class Chapter4Fig6 : MonoBehaviour
{
    ...
    public GameObject collisionPlane1, collisionPlane2, collisionPlane3, collisionPlane4;
    ...
    void Start()
    {
        ...
        maxParticles = 1000;
        psf6 = new particleSystemFigure6(particleSystemLocation, startSpeed, lifeTime, maxParticles, collisionPlane1, collisionPlane2, collisionPlane3, collisionPlane4);
    }
...
public class particleSystemFigure6
{
    ...
    GameObject collisionPlane1, collisionPlane2, collisionPlane3, collisionPlane4;

    public particleSystemFigure6(Vector3 particleSystemLocation, float startSpeed, float lifeTime, int maxParticles, GameObject collisionPlane1, GameObject collisionPlane2, GameObject collisionPlane3, GameObject collisionPlane4)
    {
        ...
        this.collisionPlane3 = collisionPlane3;
        this.collisionPlane4 = collisionPlane4;
        collisionModule(collisionPlane1, collisionPlane2, collisionPlane3, collisionPlane4);

        colorModule();
    }

    public void collisionModule(GameObject plane1, GameObject plane2, GameObject plane3, GameObject plane4)
    {
        ...
        //Since we have no world, we'll add four planes for the particles to collide against
        collisionModule.SetPlane(0, plane1.transform);
        collisionModule.SetPlane(1, plane2.transform);
        collisionModule.SetPlane(2, plane3.transform);
        collisionModule.SetPlane(3, plane4.transform);
